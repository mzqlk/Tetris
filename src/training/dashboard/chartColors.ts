 ...
 * (10.5) under the same check, so it was replaced. Thirteen direct-labelled categorical series
 ...
 * thirteenth colour is covered here by the uniqueness and hex-format contracts only.
 */
